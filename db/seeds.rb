...
Recipe.create(name: "Chicken Enchiladas", ingredients: ["Sea salt",
...
"8 ounces queso añejo or cotija, crumbled",
 ...
 Recipe.create(name: "Brussels Sprouts With Walnuts and Pomegranate", ingredients: ["1 ½ pounds brussels sprouts, trimmed and halved",
